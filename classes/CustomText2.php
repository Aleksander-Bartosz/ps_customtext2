...
{
    /** @var int $id_info - the ID of CustomText2 */
	public $id_info;

    /** @var String $text - HTML format of CustomText2 values */
	public $text;
	...
	{
		$sql = 'SELECT i.`id_info` FROM `' . _DB_PREFIX_ . 'info2` i
		LEFT JOIN `' . _DB_PREFIX_ . 'info2_shop` ish ON ish.`id_info` = i.`id_info`
